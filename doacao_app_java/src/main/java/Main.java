...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Teste de criar
            // Adotante
            Adotante adotante = new Adotante(44, "Marcus", "1234568", "Rua B, 488", "macedobeiramar@hotmail.com", "0416567298651", "11111111", "Cachorros");
            adotantedao.create(adotante);
            System.out.println("Adotante criado com ID: " + adotante.getId());
            // Protetor
            Protetor protetor = new Protetor(41, "Leandro Protetorjfd", "2345678", "Rua C, 123", "macedobeiramaru@hotmail.com", "45665676587", "22222222", "Familia");
            protetordao.create(protetor);
            System.out.println("Protetor criado com ID: " + protetor.getId());
            // Animal
            Animal animal = new Animal(38, "Rexjf", "Cachorro", "Labrador", "Bom", "Masculino", "Grande", false, 2, 'M', "BEM", protetor.getId());
            ...
            // ProcessoAdocao
            ProcessoAdocao processoAdocao = new ProcessoAdocao(35, animal, adotante, StatusProcesso.ENTREVISTA, localdate, animal.getId(), adotante.getId());
            ...
            // EtapaProcesso
            EtapaProcesso etapa = new EtapaProcesso(29, localdate, "Entrevista inicial", "PENDENTE", "ENTREVISTA", processoAdocao.getIdPAdocao());
            etapaprocessodao.create(etapa);
            System.out.println("EtapaProcesso criada com ID: " + etapa.getId());

            //Adocao
            Adocao adocao = new Adocao(28, localdate, "Adoção concluída", "Termos aceitos", processoAdocao.getIdPAdocao());
            adocaodao.create(adocao);
            System.out.println("Adocao criada com ID: " + adocao.getIdAdocao());

            // SuportePosAdocao
            SuportePosAdocao suporte = new SuportePosAdocao(47, localdate, "Consulta veterinária", "Ajuda com vacinas", adocao.getIdAdocao());
